...
A simple to use gamification-engine that lets you gamify your event or platform quickly. 
Currently supporting player/user profiles, points, and leaderboards.
Let's you share your leaderboard publicy and embed the leaderboards anywhere.
